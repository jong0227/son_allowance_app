  ...
  EconomyTopic(
    ...
    sections: [
      ...
      TopicSection(
        emoji: '🍕',
        title: '바구니를 조각내서 팔아요',
        body: '코스피 바구니 하나는 6천 원이 넘어요. 통째로 사기엔 비싸죠. '
            '그래서 피자를 조각내듯 바구니를 여러 조각으로 잘라서 팔아요. '
            '내가 사는 1주가 바로 그 한 조각이에요. '
            '바구니가 커지면 내 조각도 똑같은 비율로 커져요.',
      ),
      TopicSection(
        emoji: '⚠️',
        title: '싸다고 좋은 게 아니에요',
        body: '어떤 바구니는 10조각, 어떤 바구니는 100조각으로 잘라요. '
            '그래서 1주 값이 싸다고 더 좋은 게 아니에요. 조각 크기가 다를 뿐이거든요. '
